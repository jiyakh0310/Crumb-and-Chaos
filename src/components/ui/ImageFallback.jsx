...
/**
 * Shared gradient + grain placeholder, used both as PlaceholderArt's
 * no-photo fallback and as ResponsiveFoodImage's not-yet-loaded/error
 * state, so the two image components never drift into two different
 * "no photo" looks.
 */
export function Fallback({ alt, tone, icon: Icon, className, iconClassName }) {
  return (
